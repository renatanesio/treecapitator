execute if block ~ ~ ~ #minecraft:leaves[distance=1] if score @s tc.value matches 0 run function treecapitator:z_run/detect_leaves/summon
execute if block ~ ~ ~ #minecraft:leaves[distance=2] if score @s tc.value matches 1 run function treecapitator:z_run/detect_leaves/summon
execute if block ~ ~ ~ #minecraft:leaves[distance=3] if score @s tc.value matches 2 run function treecapitator:z_run/detect_leaves/summon
execute if block ~ ~ ~ #minecraft:leaves[distance=4] if score @s tc.value matches 3 run function treecapitator:z_run/detect_leaves/summon
