...
execute if score break_leaves tc.value matches 1 as @e[type=marker,tag=TC_Log,tag=TC_Mangrove] at @s run function treecapitator:z_run/detect_leaves/mangrove/loop
